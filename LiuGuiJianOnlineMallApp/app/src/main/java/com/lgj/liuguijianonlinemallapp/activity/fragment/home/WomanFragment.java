...
public class WomanFragment extends Fragment {
    ...
    private void init(View view){
        rv_woman=view.findViewById(R.id.rv_woman);
        adapter=new MyGoodsRecyclerViewAdapter(getContext(),goods);
        rv_woman.setLayoutManager(new StaggeredGridLayoutManager(2, StaggeredGridLayoutManager.VERTICAL));
        rv_woman.setAdapter(adapter);
